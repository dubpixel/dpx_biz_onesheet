# dpx_biz Documentation Project - Instructions for Claude
...
## Versioning
- Always include version in filename: `dpx-interactive-v1.2.html`
- Always include version in footer of each page
- Increment version for any changes

---

## CRITICAL: Pad Mapping Reference

### Firmware Arrays (from dpx_biz_frm.ino)
```cpp
...
## Hotspot Position Data (percentages for CSS positioning)

Image: `pcb-photo.png` (approximately 1152 x 808 pixels)

| Pad | Left% | Top% | Width% | Height% | Shape |
|-----|-------|------|--------|---------|-------|
| x.1 | 1.5 | 2 | 14 | 33 | arrow (down-pointing) |
| x.2 | 15.5 | 2.5 | 13 | 22 | circle |
| x.3 | 28.5 | 0.5 | 13 | 22 | circle |
| x.4 | 41.5 | 4.5 | 11 | 18 | circle |
| x.5 | 50 | 25.5 | 9.5 | 15 | circle |
| x.6 | 1.5 | 35.5 | 17 | 29 | circle |
| x.7 | 17.5 | 21.5 | 16 | 27 | circle |
| x.8 | 32 | 27.5 | 14 | 23 | circle |
| x.9 | 25 | 54.5 | 19 | 31 | circle |
| x.10 | 49 | 42 | 9 | 14 | circle |
| x.11 | 45 | 66.5 | 14 | 25 | arrow (down-pointing) |
| SW2 | 55 | 0 | 8 | 8 | rect |
| USB | 87 | 0 | 12 | 10 | rect |
| BOOT | 84 | 48 | 10 | 8 | rect |
| D1 | 87 | 69 | 7 | 6 | rect |
| midi? | 77 | 60 | 8 | 6 | rect |
| QR | 58 | 65 | 14 | 24 | rect |
